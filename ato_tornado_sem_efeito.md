...
Entidade | Padrão    
-------- | -------
Tipo de Documento | Após 'TORNAR SEM EFEITO'
Data do documento onde está o item tornado sem efeito | Após Tipo de Documento  
Tipo de edição do DODF | Sem padrão, mas geralmente entre Data do Documento e Número do DODF
Número do DODF |  Após 'n°'
Data do DODF |  Após Número do DODF
Página do DODF | Após Data do DODF 
Nome do Servidor |  Letras maiúsculas, perto de 'ato que nomeou' ou 'ato que exonerou'
Cargo Efetivo | Sem padrão, mas geralmente aparece perto do Nome do Servidor
...
**(10)** Matrícula SIAPE  
**(11)** Símbolo  
**(12)** Cargo em comissão  
**(13)** Hierarquia da lotação  
**(14)** Órgão  
